...
def generate_training_instances(parsing_system: ParsingSystem,
    ...
    for i in tqdm(range(len(sentences))):
        if trees[i].is_projective():
            ...
            # assert c.tree.head == trees[i].head
            # assert c.tree.label == trees[i].label
    return instances
...
def get_configuration_features(configuration: Configuration,
    ...
    words.append(configuration.get_stack(1))
    words.append(configuration.get_stack(2))

    # First 3 words in the buffer
    words.append(configuration.get_buffer(0))
    words.append(configuration.get_buffer(1))
    words.append(configuration.get_buffer(2))

    # Get first and second left-most and right-most child of top element of stack
    words.append(configuration.get_left_child(configuration.get_stack(0), 1))
    words.append(configuration.get_left_child(configuration.get_stack(0), 2))
    words.append(configuration.get_right_child(configuration.get_stack(0), 1))
    words.append(configuration.get_right_child(configuration.get_stack(0), 2))

    # Get first and second left-most and right-most child of second to top element of stack
    words.append(configuration.get_left_child(configuration.get_stack(1), 1))
    words.append(configuration.get_left_child(configuration.get_stack(1), 2))
    words.append(configuration.get_right_child(configuration.get_stack(1), 1))
    words.append(configuration.get_right_child(configuration.get_stack(1), 2))

    # Left-most of left-most and right-most of right-most of top and second to top element of stack
    words.append(configuration.get_left_child(configuration.get_left_child(configuration.get_stack(0), 1), 1))
    words.append(configuration.get_right_child(configuration.get_right_child(configuration.get_stack(0), 1), 1))
    words.append(configuration.get_left_child(configuration.get_left_child(configuration.get_stack(1), 1), 1))
    words.append(configuration.get_right_child(configuration.get_right_child(configuration.get_stack(1), 1), 1))
